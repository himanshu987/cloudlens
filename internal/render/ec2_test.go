...
func TestEc2Render(t *testing.T) {
	resp := aws.EC2Resp{InstanceId: "ec2-instance-1", Name: "my-instance", InstanceState: "running", InstanceType: "t2.micro", MonitoringState: "disabled", PublicDNS: "public-dns", LaunchTime: "9:00:00", AvailabilityZone: "us-east-1e"}
	var ec2 EC2
	...
	e := Fields{"ec2-instance-1", "my-instance", "running", "t2.micro", "disabled", "9:00:00", "public-dns", "us-east-1e"}
